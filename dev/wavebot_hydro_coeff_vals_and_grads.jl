...
# MH_vals = compute_vals(x_val, omegas)
# println("Hydro coeffs $MH_vals")

# AD_grads = compute_all(x_val, omegas)
# println("Hydro coeffs and jacobian $AD_grads")

# SA = surface_area(x_val)
# println("SA $SA")

# SA_and_grad = compute_SA_and_grad(x_val)
# println("SA_and-grad $SA_and_grad")

# draft_val = draft_fun(x)
# println("draft_val $draft_val")

# draft_and_grad = compute_draft_and_grad(x_val)
# println("draft_and_grad $draft_and_gradl")